		...
		for (int i = 0; i < N - n; i++)
		{
			for (int j = 0; j < N - n; j++)
			{
				...
				case SHAPES::RHOMBICDODECAHEDRON:
					...
					break;
				case SHAPES::SIERPINSKISPONAGE:
					glutSolidSierpinskiSponge(3, new double[]{1, 1, 1}, 1);
					break;
				case SHAPES::SHPERE:
...
void Menu(int value)
{
	...
	case RHOMBICDODECAHEDRON:
		...
		break;
	case SIERPINSKISPONAGE:
		shape = SIERPINSKISPONAGE;
		break;
	case SHPERE:
		shape = SHPERE;
		break;
...
int main(int argc, char** argv)
{
	...
	glutAddMenuEntry("SierpinskiSponage", SIERPINSKISPONAGE);
